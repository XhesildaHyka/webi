...
class Category(models.Model):
    category_title=models.TextField(max_length=350,null=True, blank=True)
...
class Item(models.Model):
    item_title = models.TextField(max_length=450,null=True, blank=True)
...
class Product(models.Model):
    product_title = models.CharField(max_length=450,null=True, blank=True)
